...
class SCDecoder:
    def __init__(self):
        ...
        self.DecoderManager_GetWidth.argtypes = [ctypes.c_void_p, ctypes.c_int]

        self.DecoderManager_GetHeight = dll.DecoderManager_GetHeight
        self.DecoderManager_GetHeight.restype = ctypes.c_int
        self.DecoderManager_GetHeight.argtypes = [ctypes.c_void_p, ctypes.c_int]

    def Initialize(self, input_dir, output_dir):
    ...
    def GetWidth(self, idx):
        return self.DecoderManager_GetWidth(self.manager, idx)
    
    def GetHeight(self, idx):
        return self.DecoderManager_GetHeight(self.manager, idx)
