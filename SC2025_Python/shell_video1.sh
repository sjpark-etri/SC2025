...
docker run --gpus all -it --rm -v ../VideoData2/VideoSample:/etri_workspace/Data -v ../VideoData2/Output:/etri_workspace/Output etri_scapi:0.1.4 python run_render.py --view_range 1.0 --focal 50 --num_views 49 --frame_number 0 --save_viewing
docker run --gpus all -it --rm -v ../VideoData2/VideoSample:/etri_workspace/Data -v ../VideoData2/Output:/etri_workspace/Output etri_scapi:0.1.4 python run_render_quilt.py --view_range 1.0 --focal 50 --rows 7 --cols 7 --frame_number 0
