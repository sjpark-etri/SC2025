...
#ifdef SJ_CUDA_RENDERER_EXPORTS
#define SJ_CUDA_RENDERER_API __declspec(dllexport)
#else
#define SJ_CUDA_RENDERER_API __declspec(dllimport)
#endif

class SJ_CUDA_RENDERER_API SJCUDARenderer
{
protected:
